...
class ClientRestControllerTest {
    ...
    void getAllClients_CorrectData_Returned() throws Exception {
        ...
        when(clientMapper.toClientResponseDtoList(anyCollection())).thenReturn(List.of(clientResponse, clientResponse));
        ...
        verify(clientMapper).toClientResponseDtoList(eq(clients));
    }
}
